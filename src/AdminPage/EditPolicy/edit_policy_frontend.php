<?php
  ...
  if(isset($_POST['policy_name'])){
      ...
      echo "<script>";
      echo "const policy_name = '".$policy_name."';";
      echo "</script>";
  }
...
<html>
  ...
  <head>
    <title>NGAC Policy Tool - Edit</title>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function(){
        ...
        document.querySelector('#override-policy').addEventListener('click', function() {
            if(confirm("Warning: Saving will ovveride the policy: '"+policy_name+"'!")){
                delete_policy(policy_name, false);
                ngacJS.save_db(policy_name);
            }
        ...
        ngacJS.load_db_direct(policy_name);
  ...
  <div class="header_div">
    ...
    <div class="header">
      <h1>NGAC Policy Tool - Edit <script>document.write("'"+policy_name+"'");</script></h1>
    </div>
      ...
      <div class="db-button-group">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
              <button id="override-policy" class="btn btn-primary btn-sm">
                <i class="fas fa-save"></i><br>
                Save Policy
              </button>
              <button id="save-policy" class="btn btn-primary btn-sm">
